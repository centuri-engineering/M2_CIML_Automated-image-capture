...
s = serial.Serial(con.ser_set["board_path"], con.ser_set["baudrate"])
relay_light = 16
...
# mode 'RGB'
pad = Image.new(
    "RGB", (((img.size[0] + 31) // 32) * 32, ((img.size[1] + 15) // 16) * 16,),
)
...
rad_o2 = Radiobutton(
    window, text="Start preview", variable=var_o, value=2, command=stop_overlay,
)
